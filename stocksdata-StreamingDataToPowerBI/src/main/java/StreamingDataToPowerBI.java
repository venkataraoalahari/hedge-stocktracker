...
class UploadStreamDataTask extends TimerTask {
...
//	String[] colList = {"symbol", "count"};
	...
	public UploadStreamDataTask(String[] args) {
...
public class StreamingDataToPowerBI {
	public static void main(String[] args) {
		UploadStreamDataTask task = new UploadStreamDataTask(args);
